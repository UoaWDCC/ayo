...
Ensure you have [Node](https://nodejs.org/) installed. This project requires `Node ^18.20.2 || >=20.9.0`. Installation can be found [here](https://nodejs.org/).
...
```
git clone https://github.com/UoaWDCC/ayo.git
```
